...
python ~/.envs/cant-grader/tensorflow/tensorflow/examples/image_retraining/retrain.py \
    --image_dir /data/All_training_data/Knot_pinpoint/Small_processed/1/ \
    --bottleneck_dir=/data/All_training_data/Knot_pinpoint/Small/bottlenecks/1/ \
    ...
    --intermediate_output_graphs_dir=/data/All_training_data/Knot_pinpoint/Intermediate_graphs/1/ \
    --summaries_dir=/data/All_training_data/Training_logs_for_tensorboard/Knot_pinpoint \
    --model_dir=/data/All_training_data/Raw_models \
    --output_graph=/data/All_training_data/Trained_models/Knot_pinpoint/1/graph.pb \
    --output_labels=/data/All_training_data/Trained_models/Knot_pinpoint/1/labels.txt
